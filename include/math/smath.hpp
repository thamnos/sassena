...
/**
Replaces the data within the array with its auto-correlated value using FFT
(scales with N)
*/
template <class T>
...
/**
Replaces the data within the array with its auto-correlated value using the
direct (scales with N*N)
*/
template <class T>
...
(scales with N)
*/
void auto_correlate_fftw(std::vector<std::complex<double> >& data, fftw_plan p1,
                         fftw_plan p2, fftw_complex* fftw_planspace);
