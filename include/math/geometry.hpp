...
/**
Helper class which is used to construct evenly distributed grid points on a
sphere. This class is adapted from code
on:http://local.wasp.uwa.edu.au/~pbourke/geometry/platonic/
*/
class DrawSphereHelper {
 public:
  ...
  DrawSphereHelper(CartesianCoor3D _center, const double _radius,
  ...
  inline CartesianCoor3D midpointOnSphere(CartesianCoor3D& a,
                                          CartesianCoor3D& b) {
  ...
  void drawMeshedTriangleOnSphere(CartesianCoor3D& a, CartesianCoor3D& b,
                                  CartesianCoor3D& c) {
  ...
  void drawTriangleOnSphere(CartesianCoor3D& a, CartesianCoor3D& b,
                            CartesianCoor3D& c) {
