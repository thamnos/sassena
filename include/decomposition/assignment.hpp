...
/**
Interface which represents a generic assignment of a number of tasks towards a
number of nodes
*/
class Assignment {
 protected:
 ...
 public:
  Assignment(size_t NN, size_t rank, size_t NAF)
      : NN_(NN), NAF_(NAF), rank_(rank), size_(0), offset_(0) {}
