...
class LinearMotionWalker : public MotionWalker {
 protected:
  ...
  template <class Archive>
  void serialize(Archive& ar, const unsigned int version) {
    ar& boost::serialization::base_object<MotionWalker, LinearMotionWalker>(
        *this);
    ar& m_translate;
  }
...
class FixedMotionWalker : public MotionWalker {
 protected:
  ...
  template <class Archive>
  void serialize(Archive& ar, const unsigned int version) {
    ar& boost::serialization::base_object<MotionWalker, FixedMotionWalker>(
        *this);
    ar& m_translate;
  }
...
class OscillationMotionWalker : public MotionWalker {
 protected:
  ...
  template <class Archive>
  void serialize(Archive& ar, const unsigned int version) {
    ar& boost::serialization::base_object<MotionWalker,
                                          OscillationMotionWalker>(*this);
 ...
 public:
  OscillationMotionWalker(double displace, double frequency, long sampling,
...
class RandomMotionWalker : public MotionWalker {
 protected:
  ...
  void serialize(Archive& ar, const unsigned int version) {
    ...
    ar& boost::serialization::base_object<MotionWalker, RandomMotionWalker>(
        *this);
    ar& m_displace;
    ar& m_seed;
    ar& m_direction;
 ...
 public:
  RandomMotionWalker(double displace, unsigned long seed, long sampling,
                     CartesianCoor3D direction);
  ~RandomMotionWalker();
...
/**
Brownian motion in 3D which draws the step size from a gaussian distribution for
the given mean (displace)
*/
class BrownianMotionWalker : public MotionWalker {
 protected:
  ...
  void serialize(Archive& ar, const unsigned int version) {
    translations.clear();
    ar& boost::serialization::base_object<MotionWalker, BrownianMotionWalker>(
        *this);
    ar& m_displace;
    ar& m_seed;
    ar& m_sampling;
 ...
 public:
  BrownianMotionWalker(double displace, unsigned long seed, long sampling,
                       CartesianCoor3D direction);
...
/**
Brownian motion in 3D which draws the step size from a gaussian distribution for
the given mean (displace) and constrains the motion to the maximum radius.
*/
class LocalBrownianMotionWalker : public MotionWalker {
 protected:
  ...
  void serialize(Archive& ar, const unsigned int version) {
    translations.clear();
    ar& boost::serialization::base_object<MotionWalker,
                                          LocalBrownianMotionWalker>(*this);
    ar& m_displace;
    ar& m_seed;
    ar& m_radius;
    ar& m_sampling;
 ...
 public:
  LocalBrownianMotionWalker(double radius, double displace, unsigned long seed,
...
/**
Rotational Brownian motion in 3D which draws the angular step size from a
gaussian distribution for the given mean (displace)
*/
class RotationalBrownianMotionWalker : public MotionWalker {
 ...
 public:
  RotationalBrownianMotionWalker(double displace, unsigned long seed,
                                 long sampling);
  ~RotationalBrownianMotionWalker();
