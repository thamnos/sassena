...
/**
Interface for writing coordinates staged within the distributed memory into a
file.
*/
...
class DCDCoordinateWriter : public ICoordinateWriter {
 ...
 public:
  DCDCoordinateWriter(
      std::string file, size_t blocks,
      size_t entries);  // initializes a file with the trajectory format
