...
/**
Implements all type scattering using the multipole method for spherical
...
class MPSphereScatterDevice : public AbstractScatterDevice {
 ...
 public:
  MPSphereScatterDevice(boost::mpi::communicator allcomm,
...
/**
Implements all type scattering using the multipole method for cylindrical
orientational averaging
*/
