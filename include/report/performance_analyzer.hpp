...
/**
Analyzes the information from a set of timers provided at construction and
prepares a formatted output of the corresponding statistical information.
*/
class PerformanceAnalyzer {
 ...
 public:
  PerformanceAnalyzer(boost::mpi::communicator thisworld,
                      std::map<boost::thread::id, Timer>& timer);
