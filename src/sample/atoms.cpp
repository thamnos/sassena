...
Atoms::Atoms(string filename, string fileformat) { add(filename, fileformat); }
...
//			ofile << setw(6) << "ATOM  ";           // table entry
//identifier
//			if (ati->index<100000)
//				ofile << setw(5) << ati->index;         // Atom serial
//number
//			else
...
//			ofile << setw(1) << ati->chainid;       // Chain
//identifier
//			ofile << setw(4) << ati->resseq;        // Residue sequence
//number
//			ofile << setw(1) << " ";                // Code for
//insertion of residues
//			ofile << setw(3) << "   ";              // --not used--
//			ofile << setw(8) << setiosflags(ios::fixed) <<
//setprecision(3) << frame.x[ati->index];             // Orthogonal coordinates
//for X in Angstroms
//			ofile << setw(8) << setiosflags(ios::fixed) <<
//setprecision(3) << frame.y[ati->index];             // Orthogonal coordinates
//for Y in Angstroms
//			ofile << setw(8) << setiosflags(ios::fixed) <<
//setprecision(3) << frame.z[ati->index];             // Orthogonal coordinates
//for Z in Angstroms
//			ofile << setw(6) << ati->occupancy;     // Occupancy
//			ofile << setw(6) << ati->tempFactor;    // Temperature
//factor
//			ofile << setw(10)<< "          ";       // --not used--
//			ofile << setw(2) << ati->element;       // Element symbol,
//right-justified
//			ofile << setw(2) << ati->charge;        // Charge  on the
//atom
//			ofile << endl;
//			atom_counter++;
//			line_counter++;
