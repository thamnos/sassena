/** \file
This file contains operational classes which mimic data types and encapsulate
...
size_t DivAssignment::operator[](size_t index) {
  if (index < size_) {
    ...
    Err::Inst()->write(string("offset_=") +
                       boost::lexical_cast<string>(offset_));
...
size_t DivAssignment::size() { return size_; }

size_t DivAssignment::offset() { return offset_; }
...
size_t ModAssignment::size() { return size_; }

size_t ModAssignment::offset() { return offset_; }
